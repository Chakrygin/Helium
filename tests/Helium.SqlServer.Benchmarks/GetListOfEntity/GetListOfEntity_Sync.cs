...
namespace Helium.SqlServer.Benchmarks.GetListOfEntity
{
    ...
    public class GetListOfEntity_Sync_10 : GetListOfEntity_Sync
    {
        [Params(10)]
    ...
    public class GetListOfEntity_Sync_100 : GetListOfEntity_Sync
    {
        [Params(100)]
        public override int RowCount { get; set; }
    }
    ...
    public class GetListOfEntity_Sync_1000 : GetListOfEntity_Sync
    {
        [Params(1000)]
        public override int RowCount { get; set; }
    }

    public abstract class GetListOfEntity_Sync : GetListOfEntity_Base
    {
        [Benchmark(Baseline = true)]
        public List<Item> HandCoded_ByColumnName()
        {
        ...
        [Benchmark]
        public List<Item> HandCoded_ByColumnIndex()
        {
            var result = new List<Item>(RowCount);
